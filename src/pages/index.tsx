  ...
  return (
    <>
      <PageBanner
        dismissable={false}
        message={
          <a href="https://cloud.architect.io" className="hover:text-white">
            <strong className="font-semibold">Architect Cloud</strong>
            <svg
              viewBox="0 0 2 2"
            ...
            Looking for our SaaS platform? Click here to go to cloud.architect.io &nbsp;
          ...
          frameworks={[
            {
              ...
              features: [
                ...
                >
                  Components only care about the details of your application, not its
                  infrastructure. Use simple terms like "database" and "service" to describe what
            ...
            },
            {
              ...
              features: [
                ...
                <FrameworkFeature
                  ...
                  iconClassName="bg-polo-blue-100"
                >
                  Architect automatically extracts relationships between APIs, databases, and more,
                  so that Datacenters can issue distinct application credentials and lock down
                  network traffic w/out risking developer error.
                </FrameworkFeature>,
                <Link
                ...
                <div className="flex flex-col">
                  ...
                  <dd className="mt-4 flex flex-auto flex-col text-base leading-7 text-gray-600 dark:text-gray-300">
                    <p className="flex-auto">
                      Components' focus on application relationships and architecture enables them
                      to automate security within your cloud. Every consuming application can be
                      issued unique credentials, and network traffic can be locked down so only
                      applications designed to talk to each other can resolve each other.
                    </p>
                    <p className="mt-6">
                      <Link
                        to="/docs"
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto grid max-w-2xl grid-cols-1 lg:mx-0 lg:max-w-none lg:grid-cols-3">
              {testimonials.map((testimonial, index) => (
                <div
                  key={index}
                  className="flex flex-col border-t first:border-t-0 lg:border-t-0 lg:border-l first:border-l-0 border-gray-200 lg:px-12 first:pl-0 last:pr-0 py-12 lg:py-0"
                >
                  <div
                    className={clsx({
