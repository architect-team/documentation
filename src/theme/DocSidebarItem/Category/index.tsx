...
export default function DocSidebarItemCategory({
  ...
  const hasStaticCategory = !collapsible && level === 1;
    ...
    <li
      className={clsx(
        ...
        'menu__list-item',
        {
          ...
          [styles.listWithStaticCategory]: hasStaticCategory,
        },
        className,
      )}>
      <div
        className={clsx({
          'menu__list-item-collapsible': collapsible,
          'menu__list-item-collapsible--active': isCurrentPage,
          'font-bold': hasStaticCategory,
        })}>
        {!hasStaticCategory ? (
          <Link
