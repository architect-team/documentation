...
Sometimes you want to access services running inside your cluster without exposing them publicly.
The `port-forward` command will allow you access these services on your local machine.
This can be useful for exposing non-http services for debugging.
...
For more options please take a look at our
[Readme](/reference/cli#architect-port-forward-resource-flags).
