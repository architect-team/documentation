...
The `architect init` command presents you with all the Starter Projects available and clones the one you select to your
local machine.

```bash
% architect init
? What is the name of your project? my-starter-project
? Please select a framework/language for your project (Use arrow keys or type to search)
❯ ASP.NET Core 
  Django 
  Flask 
  Go 
