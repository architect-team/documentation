...
1. The use of [expressions](/docs/components/reference/#expression-options), or pointers, to connect
   to other resources, and
2. The removal of `ports` in favor of the more feature rich [services](../services) block.
...
[environment docs](/environments/) and check out how to configure values for
[local environments](/environments/local) and [remote environments](/environments/remote)
respectively.
...
[Learn more about hot-reloading](/guides/components/tutorials/hot-reloading/nextjs/)
