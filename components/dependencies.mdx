...
Histically cloud teams have tried to avoid dependencies and coupling between microservices and APIs
...
<Card title="SPAs and single page apps" icon="link" href="/guides/static-websites">
