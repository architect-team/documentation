...
<Card title="Learn more about dependencies" icon="link" href="/components/dependencies">
  Click here to learn more about using dependencies and debugging microservice applications
</Card>
