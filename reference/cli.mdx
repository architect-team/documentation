...
title: "CLI"
description:
  "Self-service cloud environments for everyone. Achieve deployment, networking,
  and security automation all at once with Architect."
---

![](/images/logo.png)

Architect is the world's first
[DevOps-as-a-Service](https://www.architect.io/platform/) toolset designed to
help democratize environment provisioning for engineers. With Architect, anyone
can deploy any service, anywhere, for any reason with the push of a button.

Our unique approach to continuous delivery is powered by an embedded dependency
resolver. By simply asserting your microservice dependenies, Architect is able
to build a graph of your application and deploy the entire stack to your
favorite cloud provider.

Architect's CLI, which provides the full developer experience needed to create
[components](https://docs.architect.io/) and operate
[local environments](/deployments/local-environments), is fully open-source. The
CLI can deploy components locally using docker-compose, enrich the deployments
with components found in Architect's Cloud registry, and allows developers to
publish their own components to the registry both publicly and privately for
free.
...
running command...
$ architect (--version)
@architect-io/cli/1.32.1-rc.1 linux-x64 node-v16.19.0
...
_See code:
[@oclif/plugin-autocomplete](https://github.com/oclif/plugin-autocomplete/blob/v1.2.0/src/commands/autocomplete/index.ts)_
...
_See code:
[src/commands/components/versions.ts](https://github.com/architect-team/architect-cli/blob/v1.32.1-rc.1/src/commands/components/versions.ts)_
...
_See code:
[src/commands/config/get.ts](https://github.com/architect-team/architect-cli/blob/v1.32.1-rc.1/src/commands/config/get.ts)_
...
_See code:
[src/commands/config/set.ts](https://github.com/architect-team/architect-cli/blob/v1.32.1-rc.1/src/commands/config/set.ts)_
...
_See code: [src/commands/config/view.ts]()_
...
_See code:
[src/commands/deploy.ts](https://github.com/architect-team/architect-cli/blob/v1.32.1-rc.1/src/commands/deploy.ts)_
...
_See code:
[src/commands/destroy.ts](https://github.com/architect-team/architect-cli/blob/v1.32.1-rc.1/src/commands/destroy.ts)_
...
_See code:
[src/commands/dev/index.ts](https://github.com/architect-team/architect-cli/blob/v1.32.1-rc.1/src/commands/dev/index.ts)_
...
_See code:
[src/commands/dev/list.ts](https://github.com/architect-team/architect-cli/blob/v1.32.1-rc.1/src/commands/dev/list.ts)_
...
_See code:
[src/commands/dev/stop.ts](https://github.com/architect-team/architect-cli/blob/v1.32.1-rc.1/src/commands/dev/stop.ts)_
...
_See code:
[src/commands/doctor.ts](https://github.com/architect-team/architect-cli/blob/v1.32.1-rc.1/src/commands/doctor.ts)_
...
_See code:
[src/commands/environments/create.ts](https://github.com/architect-team/architect-cli/blob/v1.32.1-rc.1/src/commands/environments/create.ts)_
...
_See code:
[src/commands/environments/destroy.ts](https://github.com/architect-team/architect-cli/blob/v1.32.1-rc.1/src/commands/environments/destroy.ts)_
...
_See code:
[src/commands/exec.ts](https://github.com/architect-team/architect-cli/blob/v1.32.1-rc.1/src/commands/exec.ts)_
...
_See code:
[@oclif/plugin-help](https://github.com/oclif/plugin-help/blob/v5.1.11/src/commands/help.ts)_

### `architect init [NAME]`

Initialize an architect component from an existing docker-compose file or create
a project from Architect starter projects.
...
_See code:
[src/commands/init.ts](https://github.com/architect-team/architect-cli/blob/v1.32.1-rc.1/src/commands/init.ts)_
...
_See code:
[src/commands/link/index.ts](https://github.com/architect-team/architect-cli/blob/v1.32.1-rc.1/src/commands/link/index.ts)_
...
_See code:
[src/commands/link/list.ts](https://github.com/architect-team/architect-cli/blob/v1.32.1-rc.1/src/commands/link/list.ts)_
...
_See code:
[src/commands/login.ts](https://github.com/architect-team/architect-cli/blob/v1.32.1-rc.1/src/commands/login.ts)_
...
_See code:
[src/commands/logout.ts](https://github.com/architect-team/architect-cli/blob/v1.32.1-rc.1/src/commands/logout.ts)_
...
_See code:
[src/commands/logs.ts](https://github.com/architect-team/architect-cli/blob/v1.32.1-rc.1/src/commands/logs.ts)_

### `architect register [COMPONENT]`

Register a new Component with Architect Cloud. Multiple components are accepted.
If multiple components are specified, the same command arg(s) and flag(s) will
...
_See code:
[src/commands/register.ts](https://github.com/architect-team/architect-cli/blob/v1.32.1-rc.1/src/commands/register.ts)_
...
_See code:
[src/commands/scale.ts](https://github.com/architect-team/architect-cli/blob/v1.32.1-rc.1/src/commands/scale.ts)_
...
_See code:
[src/commands/secrets/download.ts](https://github.com/architect-team/architect-cli/blob/v1.32.1-rc.1/src/commands/secrets/download.ts)_
...
_See code:
[src/commands/secrets/upload.ts](https://github.com/architect-team/architect-cli/blob/v1.32.1-rc.1/src/commands/secrets/upload.ts)_
...
_See code:
[src/commands/task.ts](https://github.com/architect-team/architect-cli/blob/v1.32.1-rc.1/src/commands/task.ts)_
...
_See code:
[src/commands/unlink.ts](https://github.com/architect-team/architect-cli/blob/v1.32.1-rc.1/src/commands/unlink.ts)_
