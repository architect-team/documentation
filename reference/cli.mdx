...
Architect is the world's first [DevOps-as-a-Service](https://architect.io/product) toolset designed to help democratize
environment provisioning for engineers. With Architect, anyone can deploy any service, anywhere, for any reason with the
push of a button.

Architect's CLI, which provides the full developer experience needed to create [components](../guides/create-a-component)
and operate local [environments](https://docs.architect.io/deployments/local-environments), is fully open-source. The CLI
can deploy components locally using Docker Compose, enrich the deployments with components found in Architect's cloud
registry, and allow developers to publish their own components to the registry both publicly and privately for free.
...
running command...
$ architect (--version)
@architect-io/cli/1.36.1-rc.4 linux-x64 node-v16.19.1
...
_See code: [src/commands/components/versions.ts](https://github.com/architect-team/architect-cli/blob/v1.36.1-rc.4/src/commands/components/versions.ts)_
...
_See code: [src/commands/config/get.ts](https://github.com/architect-team/architect-cli/blob/v1.36.1-rc.4/src/commands/config/get.ts)_
...
_See code: [src/commands/config/set.ts](https://github.com/architect-team/architect-cli/blob/v1.36.1-rc.4/src/commands/config/set.ts)_
...
_See code: [src/commands/config/view.ts](https://github.com/architect-team/architect-cli/blob/v1.36.1-rc.4/src/commands/config/view.ts)_
...
_See code: [src/commands/deploy.ts](https://github.com/architect-team/architect-cli/blob/v1.36.1-rc.4/src/commands/deploy.ts)_
...
_See code: [src/commands/destroy.ts](https://github.com/architect-team/architect-cli/blob/v1.36.1-rc.4/src/commands/destroy.ts)_
...
_See code: [src/commands/dev/index.ts](https://github.com/architect-team/architect-cli/blob/v1.36.1-rc.4/src/commands/dev/index.ts)_
...
_See code: [src/commands/dev/list.ts](https://github.com/architect-team/architect-cli/blob/v1.36.1-rc.4/src/commands/dev/list.ts)_
...
_See code: [src/commands/dev/restart.ts](https://github.com/architect-team/architect-cli/blob/v1.36.1-rc.4/src/commands/dev/restart.ts)_
...
_See code: [src/commands/dev/stop.ts](https://github.com/architect-team/architect-cli/blob/v1.36.1-rc.4/src/commands/dev/stop.ts)_
...
_See code: [src/commands/doctor.ts](https://github.com/architect-team/architect-cli/blob/v1.36.1-rc.4/src/commands/doctor.ts)_
...
_See code: [src/commands/environments/create.ts](https://github.com/architect-team/architect-cli/blob/v1.36.1-rc.4/src/commands/environments/create.ts)_
...
_See code: [src/commands/environments/destroy.ts](https://github.com/architect-team/architect-cli/blob/v1.36.1-rc.4/src/commands/environments/destroy.ts)_
...
_See code: [src/commands/environments/ingresses.ts](https://github.com/architect-team/architect-cli/blob/v1.36.1-rc.4/src/commands/environments/ingresses.ts)_
...
_See code: [src/commands/exec.ts](https://github.com/architect-team/architect-cli/blob/v1.36.1-rc.4/src/commands/exec.ts)_
...
_See code: [src/commands/init.ts](https://github.com/architect-team/architect-cli/blob/v1.36.1-rc.4/src/commands/init.ts)_
...
_See code: [src/commands/link/index.ts](https://github.com/architect-team/architect-cli/blob/v1.36.1-rc.4/src/commands/link/index.ts)_
...
_See code: [src/commands/link/list.ts](https://github.com/architect-team/architect-cli/blob/v1.36.1-rc.4/src/commands/link/list.ts)_
...
_See code: [src/commands/login.ts](https://github.com/architect-team/architect-cli/blob/v1.36.1-rc.4/src/commands/login.ts)_
...
_See code: [src/commands/logout.ts](https://github.com/architect-team/architect-cli/blob/v1.36.1-rc.4/src/commands/logout.ts)_
...
_See code: [src/commands/logs.ts](https://github.com/architect-team/architect-cli/blob/v1.36.1-rc.4/src/commands/logs.ts)_
...
_See code: [src/commands/port-forward.ts](https://github.com/architect-team/architect-cli/blob/v1.36.1-rc.4/src/commands/port-forward.ts)_
...
_See code: [src/commands/register.ts](https://github.com/architect-team/architect-cli/blob/v1.36.1-rc.4/src/commands/register.ts)_
...
_See code: [src/commands/scale.ts](https://github.com/architect-team/architect-cli/blob/v1.36.1-rc.4/src/commands/scale.ts)_
...
_See code: [src/commands/secrets/download.ts](https://github.com/architect-team/architect-cli/blob/v1.36.1-rc.4/src/commands/secrets/download.ts)_
...
_See code: [src/commands/secrets/upload.ts](https://github.com/architect-team/architect-cli/blob/v1.36.1-rc.4/src/commands/secrets/upload.ts)_
...
_See code: [src/commands/task.ts](https://github.com/architect-team/architect-cli/blob/v1.36.1-rc.4/src/commands/task.ts)_
...
_See code: [src/commands/unlink.ts](https://github.com/architect-team/architect-cli/blob/v1.36.1-rc.4/src/commands/unlink.ts)_
