...
| -------------------- | ---------- | -------------- | -------------- |
 ...
 | `termination_grace_period` | string \| [Expression](/reference/contexts-and-interpolation) | A period of time between a service being passed a SIGINT and a SIGTERM when it's scheduled to be replaced or terminated. Only used for remote deployments. | default: `30s` |
 ...
 | `cpu` | number \| [Expression](/reference/contexts-and-interpolation) | The cpu required to run a service or a task | [More](/components/services/#cpu-and-memory) |
 | `memory` | string \| [Expression](/reference/contexts-and-interpolation) | The memory required to run a service or a task. | [More](/components/services/#cpu-and-memory) |
...
| -------------------- | ---------- | -------------- | -------------- |
 ...
 | `private` | boolean \| [Expression](/reference/contexts-and-interpolation) | Marks the ingress as private behind Architect authentication |  |
...
| Field  (*=required)  | Type       | Description    | Misc           |
| -------------------- | ---------- | -------------- | -------------- |
 | `cpu` | integer \| [Expression](/reference/contexts-and-interpolation) | The cpu usage required to trigger scaling. | [More](/components/services/#cpu-and-memory) |
 | `memory` | integer \| [Expression](/reference/contexts-and-interpolation) | The memory usage required to trigger scaling. | [More](/components/services/#cpu-and-memory) |
