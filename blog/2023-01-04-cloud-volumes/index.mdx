...
volumes: src: mount_path: /var/lib/postgresql host_path: ./db/files
...
- [Architect Documentation on Volumes](https://docs.architect.io/reference/architect-yml/#volumespec)
